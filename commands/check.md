...
- ZERO warnings from ESLint (all recommended rules enabled)
- No disabled linter rules without explicit justification
- No use of 'any' type
- No eslint-disable comments unless absolutely necessary with explanation
- Proper error handling with try/catch or Result types
- Explicit return types on all functions
- Consistent naming following TypeScript conventions
...
- [ ] No 'any' type - specific types everywhere
- [ ] Proper error handling - try/catch or Result types
- [ ] Early returns to reduce nesting
- [ ] Meaningful variable names (userId not id)
- [ ] Proper async/await usage
- [ ] No memory leaks from event listeners
- [ ] Cleanup in useEffect/lifecycle methods
- [ ] No race conditions in async code
- [ ] No synchronous blocking operations
- [ ] Promise.race() or AbortController for timeouts
...
- [ ] Debouncing/throttling where beneficial
- [ ] Connection pooling configured
- [ ] No unnecessary re-renders (React) or computations
- [ ] No synchronous blocking operations
- [ ] Efficient async coordination with Promise.all()
